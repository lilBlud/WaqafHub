        ...
        <form 
            ...
            <div class="space-y-4">
                ...
                <div class="bg-gray-200 p-4 rounded-md border border-gray-300">
                    <input type="text" name="title" value="{{ old('title') }}" placeholder="Listing Title" class="w-full border-gray-300 rounded focus:ring-waqaf-green focus:border-waqaf-green shadow-sm">
                ...
                <div class="bg-gray-200 p-4 rounded-md border border-gray-300">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <label class="cursor-pointer">
                            <input type="radio" name="condition" value="Brand New" class="peer sr-only" {{ old('condition') == 'Brand New' ? 'checked' : '' }}>
                        ...
                        <label class="cursor-pointer">
                            <input type="radio" name="condition" value="Like New" class="peer sr-only" {{ old('condition') == 'Like New' ? 'checked' : '' }}>
                        ...
                        <label class="cursor-pointer">
                            <input type="radio" name="condition" value="Lightly Used" class="peer sr-only" {{ old('condition') == 'Lightly Used' ? 'checked' : '' }}>
                        ...
                        <label class="cursor-pointer">
                            <input type="radio" name="condition" value="Heavily Used" class="peer sr-only" {{ old('condition') == 'Heavily Used' ? 'checked' : '' }}>
                ...
                <div class="bg-gray-200 p-4 rounded-md border border-gray-300">
                    ...
                    <textarea name="description" rows="3" placeholder="Write description" class="w-full border-gray-300 rounded focus:ring-waqaf-green focus:border-waqaf-green shadow-sm">{{ old('description') }}</textarea>
