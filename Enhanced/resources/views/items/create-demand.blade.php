<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="{{ route('demands.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @csrf
            ...
            <div class="space-y-4">
                <div class="bg-gray-200 p-4 rounded-md border border-gray-300">
                    <input type="text" name="title" value="{{ old('title') }}" placeholder="What do you need? (e.g. Maggi Kari, Law Book)" class="w-full border-gray-300 rounded focus:ring-waqaf-green focus:border-waqaf-green shadow-sm" required>
                ...
                <div class="bg-gray-200 p-4 rounded-md border border-gray-300">
                    ...
                    <textarea name="description" rows="4" placeholder="Why do you need this? Any specific details?" class="w-full border-gray-300 rounded focus:ring-waqaf-green focus:border-waqaf-green shadow-sm" required>{{ old('description') }}</textarea>
